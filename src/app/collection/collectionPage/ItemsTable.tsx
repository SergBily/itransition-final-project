...
// import {
//   selectCollection, selectErrorMessage, selectItems, selectStatus,
// } from '../../../redux/selectors/itemsSelector';
// import ItemStructure from '../../../shared/models/items/itemStructure';
// import { getItemsCollection, reset } from '../../../redux/features/ItemsCollectionSlice';
...
//   useEffect(() => {
//     const currentCollection: Collection | null = useAppSelector(selectCollection);
//     if (currentCollection) {
//       headCells = getHeadCell(currentCollection?.customFields);
//     }
//   }, []);
...
//   const items: ItemStructure[] = useAppSelector(selectItems);
//   const status: string = useAppSelector(selectStatus);
//   const errors: string = useAppSelector(selectErrorMessage);
...
//         <ItemsTableToolbar numSelected={selected.length} />
//         <TableContainer>
//           <Table
//             sx={{ minWidth: 750 }}
...
//                 .map((row, index) => {
//                   const isItemSelected = isSelected(items.title);
